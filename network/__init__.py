...
backbone_dict = {
    ...
    'bigresnet18_grayscale':[resnet.ResNet('resnet18',grayscale=True), 512],
    'lightresnet18':[resnet.ResNet('resnet18',cifar=True), 512],
    'lightresnet18_grayscale':[resnet.ResNet('resnet18',grayscale=True), 512],
}
