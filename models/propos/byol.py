...
class BYOL(TrainTask):
    ...
    def train(self, inputs, indices, n_iter):
        ...
        #print(images)
        #print(images.size())
        #print(len(images))  # This will tell you how many items are in the list or tuple
        #print('INTO TRAIN NUM8CLUSTER :',self.num_cluster)
        self.byol.module.num_cluster=self.num_cluster # MODIF CYRIL 24 MAI 
        im_q, im_k = images
